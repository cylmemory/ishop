...
class GoodsCategory(models.Model):
    ...
    name = models.CharField(max_length=30, default="", verbose_name="类别名称", help_text="类别名称")
    name_en = models.CharField(max_length=30, default="", verbose_name="类别英文名称", help_text="类别英文名称")
    description = models.TextField(default="", verbose_name="描述", help_text="描述")
    category_level = models.IntegerField(choices=CATEGORY_LEVEL, verbose_name="等级", help_text="等级")
...
class Goods(models.Model):
    ...
    商品
    """
    good_lot_no = models.CharField(max_length=50, default="", verbose_name="商品货号")
